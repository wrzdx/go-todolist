...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_wrzdx_go-todolist_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID получаемой задачи запроса",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "delete": {
                ...
                "responses": {
                    "204": {
                        "description": "Успешноe удаление задачи"
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
        ...
        "/users/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID получаемого пользователя запроса",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "delete": {
                ...
                "responses": {
                    "204": {
                        "description": "Успешноe удаление пользователя"
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
    ...
    "definitions": {
        "github_com_wrzdx_go-todolist_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
